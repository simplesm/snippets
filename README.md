...
snippets can be considered as a toolbox to provide the right pattern for various requirements. Quicklinks direct you to working samples and the corresponding snippets. Select the required sample and copy the source code to your clipboard.
